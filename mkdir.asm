...
main(int argc, char *argv[])
{
  ...
  47:	e8 30 04 00 00       	call   47c <mkdir>
  ...
  66:	c7 44 24 04 7f 09 00 	movl   $0x97f,0x4(%esp)
  6d:	00 
...
{	
 ...
 309:	c7 44 24 04 9b 09 00 	movl   $0x99b,0x4(%esp)
 310:	00 
 ...
 3df:	c7 44 24 04 b4 09 00 	movl   $0x9b4,0x4(%esp)
 3e6:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 535:	0f b6 80 40 0c 00 00 	movzbl 0xc40(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 692:	75 09                	jne    69d <printf+0x101>
          s = "(null)";
 694:	c7 45 f4 c4 09 00 00 	movl   $0x9c4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 75e:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 ...
 829:	a3 5c 0c 00 00       	mov    %eax,0xc5c
}
 82e:	c9                   	leave  
 82f:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 89a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 89d:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 8a2:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8a5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8a9:	75 23                	jne    8ce <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8ab:	c7 45 f0 54 0c 00 00 	movl   $0xc54,-0x10(%ebp)
 8b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8b5:	a3 5c 0c 00 00       	mov    %eax,0xc5c
 8ba:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 8bf:	a3 54 0c 00 00       	mov    %eax,0xc54
    base.s.size = 0;
 8c4:	c7 05 58 0c 00 00 00 	movl   $0x0,0xc58
 8cb:	00 00 00 
  }
 ...
 921:	a3 5c 0c 00 00       	mov    %eax,0xc5c
      return (void*)(p + 1);
 ...
 92c:	eb 38                	jmp    966 <malloc+0xde>
    ...
    if(p == freep)
 92e:	a1 5c 0c 00 00       	mov    0xc5c,%eax
