...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
      ...
      16:	e8 74 42 00 00       	call   428f <printf>
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      ...
      3b:	e8 4f 42 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      ...
      65:	e8 25 42 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      ...
      8f:	e8 fb 41 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      ...
      b9:	e8 d1 41 00 00       	call   428f <printf>
    exit();
  ...
  printf(stdout, "iput test ok\n");
      ...
      d3:	e8 b7 41 00 00       	call   428f <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      f0:	e8 9a 41 00 00       	call   428f <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     113:	e8 77 41 00 00       	call   428f <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     147:	e8 43 41 00 00       	call   428f <printf>
      exit();
    ...
    if(chdir("iputdir") < 0){
     ...
     171:	e8 19 41 00 00       	call   428f <printf>
      exit();
    ...
    if(unlink("../iputdir") < 0){
     ...
     19b:	e8 ef 40 00 00       	call   428f <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1bf:	e8 cb 40 00 00       	call   428f <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1dc:	e8 ae 40 00 00       	call   428f <printf>
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     201:	e8 89 40 00 00       	call   428f <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     229:	e8 61 40 00 00       	call   428f <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     266:	e8 24 40 00 00       	call   428f <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
    ...
    printf(stdout, "unlink failed\n");
     ...
     2a1:	e8 e9 3f 00 00       	call   428f <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2c0:	e8 ca 3f 00 00       	call   428f <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2dd:	e8 ad 3f 00 00       	call   428f <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     30f:	e8 7b 3f 00 00       	call   428f <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     351:	e8 39 3f 00 00       	call   428f <printf>
    exit();
  ...
  printf(stdout, "open test ok\n");
     ...
     36b:	e8 1f 3f 00 00       	call   428f <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     388:	e8 02 3f 00 00       	call   428f <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3ba:	e8 d0 3e 00 00       	call   428f <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3db:	e8 af 3e 00 00       	call   428f <printf>
    exit();
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     41c:	e8 6e 3e 00 00       	call   428f <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     45d:	e8 2d 3e 00 00       	call   428f <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     485:	e8 05 3e 00 00       	call   428f <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4c2:	e8 c8 3d 00 00       	call   428f <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     500:	e8 8a 3d 00 00       	call   428f <printf>
    exit();
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     51a:	e8 70 3d 00 00       	call   428f <printf>
  } else {
  ...
  if(unlink("small") < 0){
    ...
    printf(stdout, "read failed\n");
     ...
     54c:	e8 3e 3d 00 00       	call   428f <printf>
    exit();
    ...
    printf(stdout, "unlink small failed\n");
     ...
     566:	e8 24 3d 00 00       	call   428f <printf>
    exit();
  ...
  printf(stdout, "small file test ok\n");
     ...
     580:	e8 0a 3d 00 00       	call   428f <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     59d:	e8 ed 3c 00 00       	call   428f <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     5cf:	e8 bb 3c 00 00       	call   428f <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     625:	e8 65 3c 00 00       	call   428f <printf>
      exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     675:	e8 15 3c 00 00       	call   428f <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6ca:	e8 c0 3b 00 00       	call   428f <printf>
        exit();
  ...
  if(unlink("big") < 0){
     ...
     716:	e8 74 3b 00 00       	call   428f <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     74e:	e8 3c 3b 00 00       	call   428f <printf>
      exit();
    ...
    printf(stdout, "unlink big failed\n");
     ...
     771:	e8 19 3b 00 00       	call   428f <printf>
    exit();
  ...
  printf(stdout, "big files ok\n");
     ...
     78b:	e8 ff 3a 00 00       	call   428f <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     7a8:	e8 e2 3a 00 00       	call   428f <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     843:	e8 47 3a 00 00       	call   428f <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     860:	e8 2a 3a 00 00       	call   428f <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     ...
     885:	e8 05 3a 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8af:	e8 db 39 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     8d9:	e8 b1 39 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dir0") < 0){
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     903:	e8 87 39 00 00       	call   428f <printf>
    exit();
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     91d:	e8 6d 39 00 00       	call   428f <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     93a:	e8 50 39 00 00       	call   428f <printf>
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     967:	e8 23 39 00 00       	call   428f <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     997:	e8 f3 38 00 00       	call   428f <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a29:	e8 61 38 00 00       	call   428f <printf>
        exit();
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a9f:	e8 eb 37 00 00       	call   428f <printf>
    ...
    if(total != 5 * 1033){
     ...
     b15:	e8 75 37 00 00       	call   428f <printf>
      exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     b75:	e8 15 37 00 00       	call   428f <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bed:	e8 9d 36 00 00       	call   428f <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     c39:	e8 51 36 00 00       	call   428f <printf>
  ...
  printf(1, "kill... ");
     ...
     c5a:	e8 30 36 00 00       	call   428f <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     c8f:	e8 fb 35 00 00       	call   428f <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     cb2:	e8 d8 35 00 00       	call   428f <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     ce5:	e8 a5 35 00 00       	call   428f <printf>
      return;
    ...
    if(pid){
     ...
     d0b:	e8 7f 35 00 00       	call   428f <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d30:	e8 5a 35 00 00       	call   428f <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     d4c:	e8 3e 35 00 00       	call   428f <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 ed 37 00 00       	call   457b <malloc>
    ...
    while(m1){
     ...
     da7:	e8 96 36 00 00       	call   4442 <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     dbf:	e8 b7 37 00 00       	call   457b <malloc>
    ...
    if(m1 == 0){
     ...
     ddc:	e8 ae 34 00 00       	call   428f <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     e31:	e8 59 34 00 00       	call   428f <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     e6e:	e8 1c 34 00 00       	call   428f <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ee0:	e8 aa 33 00 00       	call   428f <printf>
      break;
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     f3b:	e8 4f 33 00 00       	call   428f <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fea:	e8 a0 32 00 00       	call   428f <printf>
    ...
    100e:	e8 7c 32 00 00       	call   428f <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    ...
    104b:	e8 3f 32 00 00       	call   428f <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    108e:	e8 fc 31 00 00       	call   428f <printf>
      exit();
    ...
    10cd:	e8 bd 31 00 00       	call   428f <printf>
        exit();
    ...
    113b:	e8 4f 31 00 00       	call   428f <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11df:	e8 ab 30 00 00       	call   428f <printf>
          exit();
    ...
    1249:	e8 41 30 00 00       	call   428f <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    ...
    127b:	e8 0f 30 00 00       	call   428f <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    1297:	e8 f3 2f 00 00       	call   428f <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12c5:	e8 c5 2f 00 00       	call   428f <printf>
      exit();
    ...
    1326:	e8 64 2f 00 00       	call   428f <printf>
          exit();
    ...
    137b:	e8 0f 2f 00 00       	call   428f <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1438:	e8 52 2e 00 00       	call   428f <printf>
        exit();
    ...
    146a:	e8 20 2e 00 00       	call   428f <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    14f3:	e8 97 2d 00 00       	call   428f <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    150f:	e8 7b 2d 00 00       	call   428f <printf>
  ...
  if(fd < 0){
    ...
    1540:	e8 4a 2d 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    159c:	e8 ee 2c 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("unlinkread") != 0){
    ...
    15c5:	e8 c5 2c 00 00       	call   428f <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    163b:	e8 4f 2c 00 00       	call   428f <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    165f:	e8 2b 2c 00 00       	call   428f <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1698:	e8 f2 2b 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "unlinkread ok\n");
    ...
    16c8:	e8 c2 2b 00 00       	call   428f <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    16e4:	e8 a6 2b 00 00       	call   428f <printf>
  ...
  if(fd < 0){
    ...
    172d:	e8 5d 2b 00 00       	call   428f <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1766:	e8 24 2b 00 00       	call   428f <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    ...
    17a2:	e8 e8 2a 00 00       	call   428f <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    ...
    17df:	e8 ab 2a 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1815:	e8 75 2a 00 00       	call   428f <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    184e:	e8 3c 2a 00 00       	call   428f <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    188a:	e8 00 2a 00 00       	call   428f <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    18c7:	e8 c3 29 00 00       	call   428f <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    ...
    18f8:	e8 92 29 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "linktest ok\n");
    ...
    1911:	e8 79 29 00 00       	call   428f <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    192d:	e8 5d 29 00 00       	call   428f <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1a14:	e8 76 28 00 00       	call   428f <printf>
        exit();
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1adb:	e8 af 27 00 00       	call   428f <printf>
        exit();
    ...
    1b0d:	e8 7d 27 00 00       	call   428f <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b68:	e8 22 27 00 00       	call   428f <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1ba4:	e8 e6 26 00 00       	call   428f <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    1cc4:	e8 c6 25 00 00       	call   428f <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1ce0:	e8 aa 25 00 00       	call   428f <printf>
  ...
  if(pid < 0){
    ...
    1d0e:	e8 7c 25 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    1df2:	e8 98 24 00 00       	call   428f <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    1e0e:	e8 7c 24 00 00       	call   428f <printf>
  unlink("bd");
  ...
  if(fd < 0){
    ...
    1e4b:	e8 3f 24 00 00       	call   428f <printf>
    exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    1ebf:	e8 cb 23 00 00       	call   428f <printf>
      exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    1f39:	e8 51 23 00 00       	call   428f <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1f5f:	e8 2b 23 00 00       	call   428f <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1f7b:	e8 0f 23 00 00       	call   428f <printf>
  ...
  if(mkdir("dd") != 0){
    ...
    1fab:	e8 df 22 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1fe1:	e8 a9 22 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    ...
    2030:	e8 5a 22 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2059:	e8 31 22 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    208f:	e8 fb 21 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    20eb:	e8 9f 21 00 00       	call   428f <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2133:	e8 57 21 00 00       	call   428f <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    216f:	e8 1b 21 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2198:	e8 f2 20 00 00       	call   428f <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21c9:	e8 c1 20 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    ...
    21f2:	e8 98 20 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    221b:	e8 6f 20 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2244:	e8 46 20 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    ...
    226d:	e8 1d 20 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    22a3:	e8 e7 1f 00 00       	call   428f <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22dc:	e8 ae 1f 00 00       	call   428f <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2318:	e8 72 1f 00 00       	call   428f <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2349:	e8 41 1f 00 00       	call   428f <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    237a:	e8 10 1f 00 00       	call   428f <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    23ab:	e8 df 1e 00 00       	call   428f <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23dc:	e8 ae 1e 00 00       	call   428f <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    240d:	e8 7d 1e 00 00       	call   428f <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    243e:	e8 4c 1e 00 00       	call   428f <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    246f:	e8 1b 1e 00 00       	call   428f <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    24a0:	e8 ea 1d 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24c9:	e8 c1 1d 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24f2:	e8 98 1d 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    251b:	e8 6f 1d 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2544:	e8 46 1d 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    256d:	e8 1d 1d 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    ...
    2596:	e8 f4 1c 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    ...
    25bf:	e8 cb 1c 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25e8:	e8 a2 1c 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    ...
    2611:	e8 79 1c 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    ...
    263a:	e8 50 1c 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    ...
    2663:	e8 27 1c 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    ...
    268c:	e8 fe 1b 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "subdir ok\n");
    ...
    26a5:	e8 e5 1b 00 00       	call   428f <printf>
}
    26aa:	c9                   	leave  
    26ab:	c3                   	ret    
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    26c1:	e8 c9 1b 00 00       	call   428f <printf>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    270a:	e8 80 1b 00 00       	call   428f <printf>
      exit();
    ...
    275f:	e8 2b 1b 00 00       	call   428f <printf>
        exit();
  ...
  printf(1, "bigwrite ok\n");
    ...
    27ad:	e8 dd 1a 00 00       	call   428f <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    27c9:	e8 c1 1a 00 00       	call   428f <printf>
  ...
  if(fd < 0){
    ...
    2806:	e8 84 1a 00 00       	call   428f <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2865:	e8 25 1a 00 00       	call   428f <printf>
      exit();
  ...
  if(fd < 0){
    ...
    28b0:	e8 da 19 00 00       	call   428f <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28fb:	e8 8f 19 00 00       	call   428f <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    293e:	e8 4c 19 00 00       	call   428f <printf>
      exit();
    ...
    298b:	e8 ff 18 00 00       	call   428f <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    29b3:	e8 d7 18 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "bigfile test ok\n");
    ...
    29d8:	e8 b2 18 00 00       	call   428f <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    29f4:	e8 96 18 00 00       	call   428f <printf>
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2a18:	e8 72 18 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a41:	e8 49 18 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2a77:	e8 13 18 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2ab8:	e8 d2 17 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2aec:	e8 9e 17 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2b15:	e8 75 17 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "fourteen ok\n");
    ...
    2b2e:	e8 5c 17 00 00       	call   428f <printf>
}
    2b33:	c9                   	leave  
    2b34:	c3                   	ret    
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    2b4a:	e8 40 17 00 00       	call   428f <printf>
  if(mkdir("dots") != 0){
    ...
    2b6e:	e8 1c 17 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dots") != 0){
    ...
    2b97:	e8 f3 16 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink(".") == 0){
    ...
    2bc0:	e8 ca 16 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("..") == 0){
    ...
    2be9:	e8 a1 16 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("/") != 0){
    ...
    2c12:	e8 78 16 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dots/.") == 0){
    ...
    2c3b:	e8 4f 16 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dots/..") == 0){
    ...
    2c64:	e8 26 16 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dots") != 0){
    ...
    2c8d:	e8 fd 15 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "rmdot ok\n");
    ...
    2ca6:	e8 e4 15 00 00       	call   428f <printf>
}
    2cab:	c9                   	leave  
    2cac:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2cc2:	e8 c8 15 00 00       	call   428f <printf>
  ...
  if(fd < 0){
    ...
    2cf3:	e8 97 15 00 00       	call   428f <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    ...
    2d27:	e8 63 15 00 00       	call   428f <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2d5d:	e8 2d 15 00 00       	call   428f <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2d93:	e8 f7 14 00 00       	call   428f <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2dbc:	e8 ce 14 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2de5:	e8 a5 14 00 00       	call   428f <printf>
    exit();
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2e16:	e8 74 14 00 00       	call   428f <printf>
    exit();
  ...
  if(unlink("dirfile") != 0){
    ...
    2e3f:	e8 4b 14 00 00       	call   428f <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2e75:	e8 15 14 00 00       	call   428f <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ec4:	e8 c6 13 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    ...
    2ee8:	e8 a2 13 00 00       	call   428f <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2f04:	e8 86 13 00 00       	call   428f <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f34:	e8 56 13 00 00       	call   428f <printf>
      exit();
    ...
    2f5d:	e8 2d 13 00 00       	call   428f <printf>
      exit();
  ...
  printf(1, "empty file name OK\n");
    ...
    300c:	e8 7e 12 00 00       	call   428f <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    3028:	e8 62 12 00 00       	call   428f <printf>
  ...
  if(n == 1000){
    ...
    3076:	e8 14 12 00 00       	call   428f <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    309a:	e8 f0 11 00 00       	call   428f <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30c7:	e8 c3 11 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "fork test OK\n");
    ...
    30e0:	e8 aa 11 00 00       	call   428f <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    3101:	e8 89 11 00 00       	call   428f <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    3169:	e8 21 11 00 00       	call   428f <printf>
      exit();
  ...
  if(pid < 0){
    ...
    31ad:	e8 dd 10 00 00       	call   428f <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31f0:	e8 9a 10 00 00       	call   428f <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    324e:	e8 3c 10 00 00       	call   428f <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3299:	e8 f1 0f 00 00       	call   428f <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32dd:	e8 ad 0f 00 00       	call   428f <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3344:	e8 46 0f 00 00       	call   428f <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3368:	e8 22 0f 00 00       	call   428f <printf>
    exit();
  ...
  if(c != a){
    ...
    33c5:	e8 c5 0e 00 00       	call   428f <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33fe:	e8 8c 0e 00 00       	call   428f <printf>
      exit();
    ...
    3432:	e8 58 0e 00 00       	call   428f <printf>
      kill(ppid);
  ...
  if(pipe(fds) != 0){
    ...
    347e:	e8 0c 0e 00 00       	call   428f <printf>
    exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    3583:	e8 07 0d 00 00       	call   428f <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    35c9:	e8 c1 0c 00 00       	call   428f <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    360f:	e8 7b 0c 00 00       	call   428f <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3692:	e8 f8 0b 00 00       	call   428f <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    36bf:	e8 cb 0b 00 00       	call   428f <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    36dc:	e8 ae 0b 00 00       	call   428f <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3709:	e8 81 0b 00 00       	call   428f <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    3731:	e8 59 0b 00 00       	call   428f <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    3797:	e8 f3 0a 00 00       	call   428f <printf>
    exec("echo", args);
    ...
    37c0:	e8 ca 0a 00 00       	call   428f <printf>
    ...
    3802:	e8 88 0a 00 00       	call   428f <printf>
    exit();
  ...
  if(fd < 0){
    ...
    383e:	e8 4c 0a 00 00       	call   428f <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    387e:	e8 0c 0a 00 00       	call   428f <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3968:	e8 22 09 00 00       	call   428f <printf>
    ...
    399f:	e8 eb 08 00 00       	call   428f <printf>
      break;
    ...
    39eb:	e8 9f 08 00 00       	call   428f <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    3b0f:	e8 7b 07 00 00       	call   428f <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    ...
    3b39:	e8 51 07 00 00       	call   428f <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b7e:	e8 0c 07 00 00       	call   428f <printf>
    exit();
    ...
    3b9d:	e8 ed 06 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    ...
    3bbb:	e8 cf 06 00 00       	call   428f <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  if (fd < 0) {
    ...
    3bf4:	e8 96 06 00 00       	call   428f <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    ...
    3c3e:	e8 4c 06 00 00       	call   428f <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3c7c:	e8 0e 06 00 00       	call   428f <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    3ca8:	e8 e2 05 00 00       	call   428f <printf>
    exit();
...
{	
    ...
    400b:	e8 7f 02 00 00       	call   428f <printf>
    ...
    40d2:	c7 44 24 04 9f 5e 00 	movl   $0x5e9f,0x4(%esp)
    40d9:	00 
    40da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    40e1:	e8 a9 01 00 00       	call   428f <printf>
	for (i = 0; i < NPROC; i++)
...
{
    41af:	55                   	push   %ebp
    41b0:	89 e5                	mov    %esp,%ebp
    41b2:	83 ec 18             	sub    $0x18,%esp
    41b5:	8b 45 0c             	mov    0xc(%ebp),%eax
    41b8:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    41bb:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    41c2:	00 
    41c3:	8d 45 f4             	lea    -0xc(%ebp),%eax
    41c6:	89 44 24 04          	mov    %eax,0x4(%esp)
    41ca:	8b 45 08             	mov    0x8(%ebp),%eax
    41cd:	89 04 24             	mov    %eax,(%esp)
    41d0:	e8 52 ff ff ff       	call   4127 <write>
}
    41d5:	c9                   	leave  
    41d6:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    41df:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    41e6:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    41ea:	74 17                	je     4203 <printint+0x2c>
    41ec:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    41f0:	79 11                	jns    4203 <printint+0x2c>
    neg = 1;
    41f2:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    41f9:	8b 45 0c             	mov    0xc(%ebp),%eax
    41fc:	f7 d8                	neg    %eax
    41fe:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4201:	eb 06                	jmp    4209 <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
    4209:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4210:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    4213:	8d 41 01             	lea    0x1(%ecx),%eax
    4216:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4219:	8b 5d 10             	mov    0x10(%ebp),%ebx
    421c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    421f:	ba 00 00 00 00       	mov    $0x0,%edx
    4224:	f7 f3                	div    %ebx
    4226:	89 d0                	mov    %edx,%eax
    4228:	0f b6 80 1c 66 00 00 	movzbl 0x661c(%eax),%eax
    422f:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4233:	8b 75 10             	mov    0x10(%ebp),%esi
    4236:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4239:	ba 00 00 00 00       	mov    $0x0,%edx
    423e:	f7 f6                	div    %esi
    4240:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4243:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4247:	75 c7                	jne    4210 <printint+0x39>
  if(neg)
    4249:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    424d:	74 10                	je     425f <printint+0x88>
    buf[i++] = '-';
    424f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4252:	8d 50 01             	lea    0x1(%eax),%edx
    4255:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4258:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    425d:	eb 1f                	jmp    427e <printint+0xa7>
    425f:	eb 1d                	jmp    427e <printint+0xa7>
    putc(fd, buf[i]);
    4261:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4264:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4267:	01 d0                	add    %edx,%eax
    4269:	0f b6 00             	movzbl (%eax),%eax
    426c:	0f be c0             	movsbl %al,%eax
    426f:	89 44 24 04          	mov    %eax,0x4(%esp)
    4273:	8b 45 08             	mov    0x8(%ebp),%eax
    4276:	89 04 24             	mov    %eax,(%esp)
    4279:	e8 31 ff ff ff       	call   41af <putc>
  while(--i >= 0)
    427e:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4282:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4286:	79 d9                	jns    4261 <printint+0x8a>
}
    4288:	83 c4 30             	add    $0x30,%esp
    428b:	5b                   	pop    %ebx
    428c:	5e                   	pop    %esi
    428d:	5d                   	pop    %ebp
    428e:	c3                   	ret    
...
{
    428f:	55                   	push   %ebp
    4290:	89 e5                	mov    %esp,%ebp
    4292:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4295:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    429c:	8d 45 0c             	lea    0xc(%ebp),%eax
    429f:	83 c0 04             	add    $0x4,%eax
    42a2:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    42a5:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    42ac:	e9 7c 01 00 00       	jmp    442d <printf+0x19e>
    c = fmt[i] & 0xff;
    42b1:	8b 55 0c             	mov    0xc(%ebp),%edx
    42b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    42b7:	01 d0                	add    %edx,%eax
    42b9:	0f b6 00             	movzbl (%eax),%eax
    42bc:	0f be c0             	movsbl %al,%eax
    42bf:	25 ff 00 00 00       	and    $0xff,%eax
    42c4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    42c7:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    42cb:	75 2c                	jne    42f9 <printf+0x6a>
      if(c == '%'){
    42cd:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42d1:	75 0c                	jne    42df <printf+0x50>
        state = '%';
    42d3:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    42da:	e9 4a 01 00 00       	jmp    4429 <printf+0x19a>
      } else {
        putc(fd, c);
    42df:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42e2:	0f be c0             	movsbl %al,%eax
    42e5:	89 44 24 04          	mov    %eax,0x4(%esp)
    42e9:	8b 45 08             	mov    0x8(%ebp),%eax
    42ec:	89 04 24             	mov    %eax,(%esp)
    42ef:	e8 bb fe ff ff       	call   41af <putc>
    42f4:	e9 30 01 00 00       	jmp    4429 <printf+0x19a>
      }
    } else if(state == '%'){
    42f9:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    42fd:	0f 85 26 01 00 00    	jne    4429 <printf+0x19a>
      if(c == 'd'){
    4303:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    4307:	75 2d                	jne    4336 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    4309:	8b 45 e8             	mov    -0x18(%ebp),%eax
    430c:	8b 00                	mov    (%eax),%eax
    430e:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4315:	00 
    4316:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    431d:	00 
    431e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4322:	8b 45 08             	mov    0x8(%ebp),%eax
    4325:	89 04 24             	mov    %eax,(%esp)
    4328:	e8 aa fe ff ff       	call   41d7 <printint>
        ap++;
    432d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4331:	e9 ec 00 00 00       	jmp    4422 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4336:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    433a:	74 06                	je     4342 <printf+0xb3>
    433c:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4340:	75 2d                	jne    436f <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4342:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4345:	8b 00                	mov    (%eax),%eax
    4347:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    434e:	00 
    434f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4356:	00 
    4357:	89 44 24 04          	mov    %eax,0x4(%esp)
    435b:	8b 45 08             	mov    0x8(%ebp),%eax
    435e:	89 04 24             	mov    %eax,(%esp)
    4361:	e8 71 fe ff ff       	call   41d7 <printint>
        ap++;
    4366:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    436a:	e9 b3 00 00 00       	jmp    4422 <printf+0x193>
      } else if(c == 's'){
    436f:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4373:	75 45                	jne    43ba <printf+0x12b>
        s = (char*)*ap;
    4375:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4378:	8b 00                	mov    (%eax),%eax
    437a:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    437d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4381:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4385:	75 09                	jne    4390 <printf+0x101>
          s = "(null)";
    4387:	c7 45 f4 af 5e 00 00 	movl   $0x5eaf,-0xc(%ebp)
        while(*s != 0){
    438e:	eb 1e                	jmp    43ae <printf+0x11f>
    4390:	eb 1c                	jmp    43ae <printf+0x11f>
          putc(fd, *s);
    4392:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4395:	0f b6 00             	movzbl (%eax),%eax
    4398:	0f be c0             	movsbl %al,%eax
    439b:	89 44 24 04          	mov    %eax,0x4(%esp)
    439f:	8b 45 08             	mov    0x8(%ebp),%eax
    43a2:	89 04 24             	mov    %eax,(%esp)
    43a5:	e8 05 fe ff ff       	call   41af <putc>
          s++;
    43aa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    43ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43b1:	0f b6 00             	movzbl (%eax),%eax
    43b4:	84 c0                	test   %al,%al
    43b6:	75 da                	jne    4392 <printf+0x103>
    43b8:	eb 68                	jmp    4422 <printf+0x193>
        }
      } else if(c == 'c'){
    43ba:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    43be:	75 1d                	jne    43dd <printf+0x14e>
        putc(fd, *ap);
    43c0:	8b 45 e8             	mov    -0x18(%ebp),%eax
    43c3:	8b 00                	mov    (%eax),%eax
    43c5:	0f be c0             	movsbl %al,%eax
    43c8:	89 44 24 04          	mov    %eax,0x4(%esp)
    43cc:	8b 45 08             	mov    0x8(%ebp),%eax
    43cf:	89 04 24             	mov    %eax,(%esp)
    43d2:	e8 d8 fd ff ff       	call   41af <putc>
        ap++;
    43d7:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    43db:	eb 45                	jmp    4422 <printf+0x193>
      } else if(c == '%'){
    43dd:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    43e1:	75 17                	jne    43fa <printf+0x16b>
        putc(fd, c);
    43e3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    43e6:	0f be c0             	movsbl %al,%eax
    43e9:	89 44 24 04          	mov    %eax,0x4(%esp)
    43ed:	8b 45 08             	mov    0x8(%ebp),%eax
    43f0:	89 04 24             	mov    %eax,(%esp)
    43f3:	e8 b7 fd ff ff       	call   41af <putc>
    43f8:	eb 28                	jmp    4422 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    43fa:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    4401:	00 
    4402:	8b 45 08             	mov    0x8(%ebp),%eax
    4405:	89 04 24             	mov    %eax,(%esp)
    4408:	e8 a2 fd ff ff       	call   41af <putc>
        putc(fd, c);
    440d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4410:	0f be c0             	movsbl %al,%eax
    4413:	89 44 24 04          	mov    %eax,0x4(%esp)
    4417:	8b 45 08             	mov    0x8(%ebp),%eax
    441a:	89 04 24             	mov    %eax,(%esp)
    441d:	e8 8d fd ff ff       	call   41af <putc>
      }
      state = 0;
    4422:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    4429:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    442d:	8b 55 0c             	mov    0xc(%ebp),%edx
    4430:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4433:	01 d0                	add    %edx,%eax
    4435:	0f b6 00             	movzbl (%eax),%eax
    4438:	84 c0                	test   %al,%al
    443a:	0f 85 71 fe ff ff    	jne    42b1 <printf+0x22>
    }
  }
}
    4440:	c9                   	leave  
...
{
    4442:	55                   	push   %ebp
    4443:	89 e5                	mov    %esp,%ebp
    4445:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4448:	8b 45 08             	mov    0x8(%ebp),%eax
    444b:	83 e8 08             	sub    $0x8,%eax
    444e:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4451:	a1 c8 66 00 00       	mov    0x66c8,%eax
    4456:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4459:	eb 24                	jmp    447f <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    445b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    445e:	8b 00                	mov    (%eax),%eax
    4460:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4463:	77 12                	ja     4477 <free+0x35>
    4465:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4468:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    446b:	77 24                	ja     4491 <free+0x4f>
    446d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4470:	8b 00                	mov    (%eax),%eax
    4472:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4475:	77 1a                	ja     4491 <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4477:	8b 45 fc             	mov    -0x4(%ebp),%eax
    447a:	8b 00                	mov    (%eax),%eax
    447c:	89 45 fc             	mov    %eax,-0x4(%ebp)
    447f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4482:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4485:	76 d4                	jbe    445b <free+0x19>
    4487:	8b 45 fc             	mov    -0x4(%ebp),%eax
    448a:	8b 00                	mov    (%eax),%eax
    448c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    448f:	76 ca                	jbe    445b <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    4491:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4494:	8b 40 04             	mov    0x4(%eax),%eax
    4497:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    449e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44a1:	01 c2                	add    %eax,%edx
    44a3:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44a6:	8b 00                	mov    (%eax),%eax
    44a8:	39 c2                	cmp    %eax,%edx
    44aa:	75 24                	jne    44d0 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    44ac:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44af:	8b 50 04             	mov    0x4(%eax),%edx
    44b2:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44b5:	8b 00                	mov    (%eax),%eax
    44b7:	8b 40 04             	mov    0x4(%eax),%eax
    44ba:	01 c2                	add    %eax,%edx
    44bc:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44bf:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    44c2:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44c5:	8b 00                	mov    (%eax),%eax
    44c7:	8b 10                	mov    (%eax),%edx
    44c9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44cc:	89 10                	mov    %edx,(%eax)
    44ce:	eb 0a                	jmp    44da <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    44d0:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44d3:	8b 10                	mov    (%eax),%edx
    44d5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44d8:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    44da:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44dd:	8b 40 04             	mov    0x4(%eax),%eax
    44e0:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    44e7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44ea:	01 d0                	add    %edx,%eax
    44ec:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    44ef:	75 20                	jne    4511 <free+0xcf>
    p->s.size += bp->s.size;
    44f1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44f4:	8b 50 04             	mov    0x4(%eax),%edx
    44f7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44fa:	8b 40 04             	mov    0x4(%eax),%eax
    44fd:	01 c2                	add    %eax,%edx
    44ff:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4502:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4505:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4508:	8b 10                	mov    (%eax),%edx
    450a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    450d:	89 10                	mov    %edx,(%eax)
    450f:	eb 08                	jmp    4519 <free+0xd7>
  } else
    p->s.ptr = bp;
    4511:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4514:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4517:	89 10                	mov    %edx,(%eax)
  freep = p;
    4519:	8b 45 fc             	mov    -0x4(%ebp),%eax
    451c:	a3 c8 66 00 00       	mov    %eax,0x66c8
}
    4521:	c9                   	leave  
    4522:	c3                   	ret    
...
{
    4523:	55                   	push   %ebp
    4524:	89 e5                	mov    %esp,%ebp
    4526:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4529:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4530:	77 07                	ja     4539 <morecore+0x16>
    nu = 4096;
    4532:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4539:	8b 45 08             	mov    0x8(%ebp),%eax
    453c:	c1 e0 03             	shl    $0x3,%eax
    453f:	89 04 24             	mov    %eax,(%esp)
    4542:	e8 48 fc ff ff       	call   418f <sbrk>
    4547:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    454a:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    454e:	75 07                	jne    4557 <morecore+0x34>
    return 0;
    4550:	b8 00 00 00 00       	mov    $0x0,%eax
    4555:	eb 22                	jmp    4579 <morecore+0x56>
  hp = (Header*)p;
    4557:	8b 45 f4             	mov    -0xc(%ebp),%eax
    455a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    455d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4560:	8b 55 08             	mov    0x8(%ebp),%edx
    4563:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4566:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4569:	83 c0 08             	add    $0x8,%eax
    456c:	89 04 24             	mov    %eax,(%esp)
    456f:	e8 ce fe ff ff       	call   4442 <free>
  return freep;
    4574:	a1 c8 66 00 00       	mov    0x66c8,%eax
}
    4579:	c9                   	leave  
    457a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    4584:	83 c0 07             	add    $0x7,%eax
    4587:	c1 e8 03             	shr    $0x3,%eax
    458a:	83 c0 01             	add    $0x1,%eax
    458d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4590:	a1 c8 66 00 00       	mov    0x66c8,%eax
    4595:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4598:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    459c:	75 23                	jne    45c1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    459e:	c7 45 f0 c0 66 00 00 	movl   $0x66c0,-0x10(%ebp)
    45a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    45a8:	a3 c8 66 00 00       	mov    %eax,0x66c8
    45ad:	a1 c8 66 00 00       	mov    0x66c8,%eax
    45b2:	a3 c0 66 00 00       	mov    %eax,0x66c0
    base.s.size = 0;
    45b7:	c7 05 c4 66 00 00 00 	movl   $0x0,0x66c4
    45be:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    45c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    45c4:	8b 00                	mov    (%eax),%eax
    45c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    45c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45cc:	8b 40 04             	mov    0x4(%eax),%eax
    45cf:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    45d2:	72 4d                	jb     4621 <malloc+0xa6>
      if(p->s.size == nunits)
    45d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45d7:	8b 40 04             	mov    0x4(%eax),%eax
    45da:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    45dd:	75 0c                	jne    45eb <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    45df:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45e2:	8b 10                	mov    (%eax),%edx
    45e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    45e7:	89 10                	mov    %edx,(%eax)
    45e9:	eb 26                	jmp    4611 <malloc+0x96>
      else {
        p->s.size -= nunits;
    45eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45ee:	8b 40 04             	mov    0x4(%eax),%eax
    45f1:	2b 45 ec             	sub    -0x14(%ebp),%eax
    45f4:	89 c2                	mov    %eax,%edx
    45f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45f9:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    45fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45ff:	8b 40 04             	mov    0x4(%eax),%eax
    4602:	c1 e0 03             	shl    $0x3,%eax
    4605:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4608:	8b 45 f4             	mov    -0xc(%ebp),%eax
    460b:	8b 55 ec             	mov    -0x14(%ebp),%edx
    460e:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4611:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4614:	a3 c8 66 00 00       	mov    %eax,0x66c8
      return (void*)(p + 1);
    4619:	8b 45 f4             	mov    -0xc(%ebp),%eax
    461c:	83 c0 08             	add    $0x8,%eax
    461f:	eb 38                	jmp    4659 <malloc+0xde>
    }
    if(p == freep)
    4621:	a1 c8 66 00 00       	mov    0x66c8,%eax
    4626:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4629:	75 1b                	jne    4646 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    462b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    462e:	89 04 24             	mov    %eax,(%esp)
    4631:	e8 ed fe ff ff       	call   4523 <morecore>
    4636:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4639:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    463d:	75 07                	jne    4646 <malloc+0xcb>
        return 0;
    463f:	b8 00 00 00 00       	mov    $0x0,%eax
    4644:	eb 13                	jmp    4659 <malloc+0xde>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4646:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4649:	89 45 f0             	mov    %eax,-0x10(%ebp)
    464c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    464f:	8b 00                	mov    (%eax),%eax
    4651:	89 45 f4             	mov    %eax,-0xc(%ebp)
  }
    4654:	e9 70 ff ff ff       	jmp    45c9 <malloc+0x4e>
}
    4659:	c9                   	leave  
    465a:	c3                   	ret    
